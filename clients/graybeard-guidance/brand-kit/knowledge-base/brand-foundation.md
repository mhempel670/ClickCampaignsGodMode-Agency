# THE GRAYBEARD PROJECT — BRANDING DOCUMENT
Prepared for Scale Plus (God Mode) Build — v2

## SECTION 0: BRAND ARCHITECTURE & DOMAINS

The Graybeard Project is the parent brand — the mission and philosophy everything sits under.

| Name | Role | Domain |
|------|------|--------|
| The Graybeard Project | Parent brand / mission / positioning | umbrella — no standalone site |
| Graybeard Radio | List-building front door + podcast funnel. Captures name/email, then routes to podcast platforms | graybeardradio.com |
| The Graybeard Assessment | Flagship paid product — AI-powered wisdom extraction | graybeardassessment.com |
| Graybeard Guidance | Business/correspondence identity | matt@graybeardguidance.com |

**How the funnel runs:** Graybeard Radio is the entry point — visitor lands, drops name + email, gets routed straight to the podcast on their platform of choice. That list then gets nurtured toward the Assessment at graybeardassessment.com. Guidance is the email/business identity behind all of it.
...
- The Graybeard Assessment (flagship product) — graybeardassessment.com
- Graybeard Guidance (business identity) — matt@graybeardguidance.com

**Social Handles:** @graybeard_og (Instagram, YouTube, Facebook, TikTok)  
**Storefront:** Stan Store (linked in Instagram bio)

---

## SECTION 2: CORE POSITIONING — CLARITY IS THE PRODUCT

This is the lead theme. Everything else supports it.

You're a seasoned professional — blue collar or white collar, doesn't matter which. Decades of hard-won wisdom and experience, a lot of which you don't even realize you know. It's just "how you do things" to you. It's gold to everyone else.

The guys this is for aren't done. They're late career or early retirement, and they want to stay in the game — just not necessarily at the pace of the last twenty-five years. They want to use what they know for good: mentor, teach, share, build something that matters. They just don't know how to get to it.

**The real number one need isn't "monetize your expertise." It's clarity.**
...
## SECTION 3: SECONDARY THEME — AI AS AMPLIFIER, NOT REPLACEMENT
...
**Tone in one line:** Guys over a beer talking about something that actually matters. Serious subject, light touch.

**Five characteristics:**
1. Authentic & Real — peer-to-peer, not guru-to-follower
...
**Language we use:** clarity, your next chapter, hard-won wisdom, what you don't even know you know, staying in the game (not "the grind"), impact and income.

**Language we avoid:** retirement, senior/elderly, guru, disruption, crushing it, passive income, secrets/hacks, corporate jargon — and don't open with AI talk.

**Voice sample:**
- ✅ "You've probably forgotten more than most guys will ever learn. The question is just — what do you do with it now?"
- ❌ "Leverage AI to unlock your hidden potential and disrupt the marketplace!"
...
| Color | Hex | Use |
|-------|-----|-----|
| Charcoal | #2B2B2B | Primary — backgrounds, headers, dominant neutral |
| Black | #121212 | Primary — text, high-contrast elements |
| Yellow Gold | #D4A017 | Accent — CTAs, highlights, icons (the "earned" color) |
| Brick Red / Maroon | #8C2F26 | Accent — secondary CTAs, emphasis |
| White | #F7F5F0 warm / #FFFFFF pure | Neutral — space, contrast, body backgrounds |

**Allocation:** charcoal/black ~50%, white ~30%, gold ~12% (primary CTA), brick/maroon ~8% (secondary emphasis). Don't let gold and brick compete on the same element.

### Typography

- **Headings:** sturdy slab/transitional serif — Roboto Slab, Spectral, or Tiempos
- **Body:** clean, high-readability sans — Source Sans Pro, Lato, or Open Sans (audience skews 50+, prioritize legibility)
...
|------|-------|-------|--------|
| 1 | Lead magnet / list-builder via Graybeard Radio | Free | Live mechanism — drives podcast + list |
| 2 | The Graybeard Assessment | $199 | Live / flagship |
| 3 | Bridge: Assessment + coaching calls, or strategy session | $997–$1,497 | To build |
...
- "AI doesn't replace your experience. It helps you organize and share it."

---

## SECTION 10: SALES PAGE — THE GRAYBEARD ASSESSMENT

**Hero Headline:** You Know More Than You Think You Know. Let's Find Out What To Do With It.

**Subhead:** A clear path to your next chapter — built from decades of experience you've already earned, not a course you have to start from scratch.

**Hero body:** You've spent thirty-plus years solving real problems — on a job site, in a boardroom, running a crew, running a company. A lot of what you know feels routine to you. It isn't. It's exactly what someone else would pay to shortcut. The Graybeard Assessment gives you clarity: what you actually know, what's worth sharing, and where it can go from here.

**CTA:** Get Your Assessment Now — $199

**Section: How It Works** — Purchase → 60-min guided conversation (your own time, AI-assisted) → blueprint in 5–7 days → decide your next move.
...
**Final CTA:** You've Got the Wisdom. Let's Get You Clarity. → Get Your Assessment Now – $199

---

## SECTION 11: EMAIL — WELCOME SEQUENCE (SAMPLE)

- **Email 1 — Welcome:** Set expectations, invite to follow social, CTA to latest podcast episode.
- **Email 2 — Subject:** "You probably know more than you think." Lead with the clarity theme — what feels routine to you is valuable to others.
- **Email 3 — Subject:** "What's actually next for you?" Speak to the late-career/early-retirement crossroads directly. Light, conversational, a little wry.
- **Email 4 — How it works.** Walk through the Assessment, mention AI as the mechanism (not the headline).
- **Email 5 — Direct invitation.** No-pressure pitch, clear CTA.

---

## SECTION 12: SOCIAL CONTENT PILLARS

- **Educational (40%)** — clarity frameworks, "what you don't know you know," redeployment ideas
- **Inspirational (30%)** — real stories of guys figuring out their next chapter
- **Relational (20%)** — behind-the-scenes, dry-humor personal takes, engagement
- **Promotional (10%)** — Assessment + Stan Store offers, episode drops

**Hashtags:** #GraybeardProject #YourNextChapter #StayInTheGame

---

## SECTION 13: BRAND PERSONALITY

If The Graybeard Project were a person: a guy who's done real work, equally at home in work boots or business casual, wise without being preachy, dry sense of humor, talks like he's at a bar with you rather than presenting from a stage. Ordinary guy, occasionally extraordinary results. Not a motivational guru, not a tech evangelist, not pretending AI is the star of the story.
